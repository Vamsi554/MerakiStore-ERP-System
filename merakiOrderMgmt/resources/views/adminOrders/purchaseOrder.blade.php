          ...
          <div class="box">
            ...
            <div class="box-body">
              @if(Session::has('success'))
               ...
               <form method="POST" action="{{ URL::to('/') }}/order/admin/purchaseOrder/save/{{ $orderId }}" autocomplete="off">
                        ...
                        <?php $i = 0; ?>
                          @foreach ($enquiryRequirements as $enquiryReq)
                            <tr id='addr<?php echo $i; ?>'>
                              ...
                              <td style="width: 100px;"><input class="form-control" type="number" min="0" id="gst{{ $i }}" name="gstTax[]" value="{{ $gstTaxArr[$i] }}" required></td>
                            </tr>
                            <?php $i++; ?>
                          @endforeach
                        </tbody>
                   ...
                   <table class="table table-bordered table-striped">
                     ...
                     <tr class="{{ $errors->has('notes') ? 'has-error' : '' }}">
                         ...
                         <td>
                           ...
                           name="notes" size="27" style="width:100%!important" value="{{ old('notes') }}" required>
