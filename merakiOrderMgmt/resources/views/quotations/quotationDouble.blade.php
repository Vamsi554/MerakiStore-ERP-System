...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <h4>{{ $enquiryQuote[1]->product_description }} Features</h4>
      <div class="row">
        <div class="column">
          <h4 class="box-title">Product Features</h4>
          <ul>
            <li>Product Style: {{ $enquiryRequirements[1]->product_style }}</li>
            <li>Material: {{ $enquiryRequirements[1]->material }}</li>
            <li>Quality: {{ $enquiryRequirements[1]->quality }}</li>
            <li>Fabric: {{ $enquiryRequirements[1]->fabric }}</li>
            <li>Colour: {{ $enquiryRequirements[1]->colour }}</li>
            @if ($enquiryRequirements[1]->additional_features != 'N/A')
              <li>Additional Features: {{ $enquiryRequirements[1]->additional_features }}</li>
            @endif
          </ul>
        </div>
        <div class="column">
          <h4 class="box-title">Product Customizations</h4>
          <ul>
            <li>Print Methods: {{ $enquiryRequirements[1]->product_style }}</li>
            <li>Print Placements: {{ $enquiryRequirements[1]->material }}</li>
            <li>Print Area: {{ $enquiryRequirements[1]->quality }}</li>
            <li>Measurements: {{ $enquiryRequirements[1]->fabric }}</li>
            @if ($enquiryRequirements[1]->additional_customizations != 'N/A')
              <li>Additional Customization: {{ $enquiryRequirements[1]->additional_customizations }}</li>
            @endif
          </ul>
        </div>
      </div>
      ...
      <h4>Conditions</h4>
      <ul>
        <li>Finishing: {{ $enquiryRequirements[1]->finishing }}</li>
        <li>Packaging: {{ $enquiryRequirements[1]->packaging }}</li>
        <li>Inclusive: {{ $enquiryRequirements[1]->inclusive }}</li>
        <li>Exclusive: {{ $enquiryRequirements[1]->exclusive }}</li>
      </ul>
