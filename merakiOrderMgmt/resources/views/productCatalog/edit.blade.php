                       ...
                       <h4 class="box-title"> Product Details </h4>
                           ...
                           <tr class="{{ $errors->has('artWorkLogo') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="artWorkLogo" size="27" style="width:100%!important" value="{{ $productCatalog->art_work_logo }}" required>
                           ...
                           <tr class="{{ $errors->has('finishing') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="finishing" size="27" style="width:100%!important" value="{{ $productCatalog->finishing }}" required>
                           ...
                           <tr class="{{ $errors->has('fittingSizes') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="fittingSizes" size="27" style="width:100%!important" value="{{ $productCatalog->fitting_sizes }}" required>
                           ...
                           <tr class="{{ $errors->has('packaging') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="packaging" size="27" style="width:100%!important" value="{{ $productCatalog->packaging }}" required>
                           ...
                           <tr class="{{ $errors->has('inclusive') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="inclusive" size="27" style="width:100%!important" value="{{ $productCatalog->inclusive }}" required>
                           ...
                           <tr class="{{ $errors->has('exclusive') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="exclusive" size="27" style="width:100%!important" value="{{ $productCatalog->exclusive }}" required>
                            ...
                            <tbody>
                              ...
                              @for($i=0; $i<count($statusArr); $i++)
                                <tr id="addr<?php echo $i?>">
                                    ...
                                    <option selected="selected">{{ $statusArr[$i] }}</option>
                                    @if ($statusArr[$i] != 'Enable')
                                      <option>Enable</option>
                                    @endif
                                    @if ($statusArr[$i] != 'Disable')
                                      <option>Disable</option>
                                    @endif
                                  </select>
                                  </td>
                                  <td>
                                    <input class="form-control" type="text" name="featureText[]" value="{{ $featureTextArr[$i] }}" required>
                                  </td>
                                </tr>
                              @endfor
                              <tr id="addr<?php echo $i?>">
