        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Vendor Update Form </h3>
            </div>

            <div class="box-body">
               <form method="POST" class="form-group" action="{{ URL::to('/') }}/meraki/vendors/updateVendor/{{ $vendor->id }}" autocomplete="off">
                       ...
                       <h4 class="box-title"> Vendor Details </h4>
                           ...
                           <tr class="{{ $errors->has('vendorCode') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="vendorCode" size="27" style="width:100%!important" value="{{ $vendor->vendor_code }}" required>
                           ...
                           <tr class="{{ $errors->has('vendorName') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="vendorName" size="27" style="width:100%!important" value="{{ $vendor->vendor_name }}" required>
                           ...
                           <tr class="{{ $errors->has('vendorPhone') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="vendorPhone" size="27" style="width:100%!important" value="{{ $vendor->vendor_phone }}" required>
                           ...
                           <tr class="{{ $errors->has('vendorCompany') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="vendorCompany" size="27" style="width:100%!important" value="{{ $vendor->vendor_company }}" required>
                           ...
                           <tr class="{{ $errors->has('vendorAddress1') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="vendorAddress1" size="27" style="width:100%!important" value="{{ $vendor->vendor_address1 }}" required>
                           ...
                           <tr class="{{ $errors->has('vendorAddress2') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="vendorAddress2" size="27" style="width:100%!important" value="{{ $vendor->vendor_address2 }}" required>
                           ...
                           <tr class="{{ $errors->has('street') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="street" size="27" style="width:100%!important" value="{{ $vendor->street }}" required>
                           ...
                           <tr class="{{ $errors->has('city') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="city" size="27" style="width:100%!important" value="{{ $vendor->city }}" required>
                           ...
                           <tr class="{{ $errors->has('state') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="state" size="27" style="width:100%!important" value="{{ $vendor->state }}" required>
                           ...
                           <tr class="{{ $errors->has('zipCode') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="zipCode" size="27" style="width:100%!important" value="{{ $vendor->zipcode }}" required>
                           ...
                           <tr class="{{ $errors->has('vendorTin') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="vendorTin" size="27" style="width:100%!important" value="{{ $vendor->vendor_TIN }}" required>
                           ...
                           <tr class="{{ $errors->has('vendorCst') ? 'has-error' : '' }}">
                               ...
                               <td>
                                 ...
                                 name="vendorCst" size="27" style="width:100%!important" value="{{ $vendor->vendor_CST }}" required>
