...
4.Primary data refers to the Product Catalog Features and Customizations Details, Vendor Details in the system, Users of the ERP application.
...
9.As requirements arise, new pages need to be developed and logic needs to be written. Existing code might also to be reworked at times during the maintenance phase. 
